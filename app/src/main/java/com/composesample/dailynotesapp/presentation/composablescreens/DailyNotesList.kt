...
import com.composesample.dailynotesapp.activities.Constants.Companion.setSelectedNotes
                              ...
                              itemsIndexed(it)
                              {
                                  ...
                                  Text(
                                      ...
                                      modifier = Modifier
                                          ...
                                          .background(
                                              color = if(isShowActionsIcons.value){if(setSelectedNotes.contains(index)){Color.Gray}else{Color.LightGray}}else{Color.LightGray},
